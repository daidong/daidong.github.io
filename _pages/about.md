...
- [01/27] **FaultyRank** is accepted by [IPDPS'23](https://www.ipdps.org). Congrats to Saisha Kamat and Abdullah Al Raqibul Islam! Saisha Kamat's first paper! This paper proposes a new graph-based method to check and repair inconsistencies in parallel file systems.
- [01/27] **Drill** is accepted by [IPDPS'23](https://www.ipdps.org). Congrats to Di Zhang and Chris Egersdoerfer! In this paper, we propose leveraging content-based and context-based features to better understand file system logs for accurate anomaly detection. 
- [01/27] **DGAP** is accepted by [FAST'23 WiP](https://www.usenix.org/conference/fast23). Congrats to Abdullah Al Raqibul Islam! This Work-in-Progress paper introduces our latest progress in building an efficient dynamic graph processing framework based on persistent memory devices.
...
- **[IPDPS'23]** Drill: Log-based Anomaly Detection for Large-scale Storage Systems Using Source Code Analysis. _Di Zhang, Chris Egersdoerfer, Tabassum Mahmud, Mai Zheng, Dong Dai_. Accepted to appear in 37th IEEE International Parallel & Distributed Processing Symposium, 2023 
- **[IPDPS'23]** FaultyRank: A Graph-based Parallel File System Checker. _Saisha Kamat, Abdullah Al Raqibul Islam, Mai Zheng, Dong Dai_. Accepted to appear in 37th IEEE International Parallel & Distributed Processing Symposium, 2023
- **[FAST'23 WiP]** A Framework for Large Dynamic Graph Analysis on Persistent  Memory, _Abdullah Al Raqibul Islam, Dong Dai_, Accepted to appear in 21st USENIX Conference on File and Storage Technologies (Work-in-Progress), 2023. [Paper](https://daidong.github.io/files/FAST23_wip_DGAP.pdf)
- **[FAST'23 WiP]** On the Scalability of Testing the Crash Consistency of PM Systems, _Duo Zhang, Om Rameshwar Gatla, Abdullah Al Raqibul Islam, Dong Dai, Mai Zheng_, Accepted to appear in 21st USENIX Conference on File and Storage Technologies (Work-in-Progress), 2023. [Paper](https://daidong.github.io/files/FAST23WIP_pm_crashconsistency.pdf)
- **[FTXS-SC'22 Workshop]** ClusterLog: Clustering Logs for Effective Log-based Anomaly Detection. _Chris Egersdoerfer, Di Zhang, Dong Dai_. Accepted in Workshop on Fault Tolerance for HPC at eXtreme Scale (with SC'22). [Paper](https://daidong.github.io/files/clusterlog-ftxs22.pdf)
- **[SRC-SC'22 Poster]** IOPathTune: Adaptive Online Parameter Tuning for Parallel File System I/O Path. _Md. Hasanur Rashid, Dong Dai_. Accepted in SC'22 ACM Student Research Competition. [Poster](https://daidong.github.io/files/iopathtune-sc22-poster.pdf)
