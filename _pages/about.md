...
- [01/23] **FaultyRank** is accepted by [IPDPS'23](https://www.ipdps.org). Congrats to Saisha Kamat and Abdullah Al Raqibul Islam! This is Saisha Kamat's first paper! In this paper, we propose a new graph-based way to check and repair metadata inconsistencies in parallel file systems, such as Lustre.
- [01/23] **Drill** is accepted by [IPDPS'23](https://www.ipdps.org). Congrats to Di Zhang and Chris Egersdoerfer! In this paper, we propose to combine both content-based sentiment and context-based features to better understand file system logs and detect the possible anomaly. 
- [01/23] **DGAP** is accepted by [FAST'23 WiP](https://www.usenix.org/conference/fast23). Congrats to Abdullah Al Raqibul Islam! In this Working-In-Progress paper, we introduce our latest work in building efficient dynamic graph processing framework based on persistent memory devices.
...
- **[IPDPS'23]** Drill: Log-based Anomaly Detection for Large-scale Storage Systems Using Source Code Analysis. _Di Zhang, Chris Egersdoerfer, Tabassum Mahmud, Mai Zheng, Dong Dai_. Accepted to appear in 37th IEEE International Parallel & Distributed Processing Symposium, 2023 [Paper]()
- **[IPDPS'23]** FaultyRank: A Graph-based Parallel File System Checker. _Saisha Kamat, Abdullah Al Raqibul Islam, Mai Zheng, Dong Dai_. Accepted to appear in 37th IEEE International Parallel & Distributed Processing Symposium, 2023 [Paper]()
- **[FAST'23 WiP]** A Framework for Large Dynamic Graph Analysis on Persistent  Memory, _Abdullah Al Raqibul Islam, Dong Dai_, Accepted to appear in 21st USENIX Conference on File and Storage Technologies (Work-in-Progress), 2023 [Paper]()
- **[FAST'23 WiP]** On the Scalability of Testing the Crash Consistency of PM Systems, _Duo Zhang, Om Rameshwar Gatla, Abdullah Al Raqibul Islam, Dong Dai, Mai Zheng_, Accepted to appear in 21st USENIX Conference on File and Storage Technologies (Work-in-Progress), 2023 [Paper]()
