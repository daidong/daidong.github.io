...
If you've tried the app, feel free to leave your thoughts in the comments below — feedback is very welcome.

---

## It's a Research Assistant, Not a Writing Machine
...
## Built-in Skills You Can Extend
...
# Research Copilot — 面向学术研究者的 AI 实验室搭档

**GitHub:** [github.com/daidong/PiPilot](https://github.com/daidong/PiPilot) &nbsp;|&nbsp; **主页:** [daidong.github.io/PiPilot](https://daidong.github.io/PiPilot/) &nbsp;|&nbsp; **安装:** `npm install -g research-copilot && research-copilot`

如果你试用了，欢迎在下方评论区留下你的想法和意见。
