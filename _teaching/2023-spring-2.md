...
## Who are doing this?
In Spring 2023, faculty members in the Parallel High-Performance Computing Lab (PHPC) are doing this. We are Tyler Allen, Dong Dai, Erik Saule, and Yonghong Yan. We and our Ph.D. students will be mentoring your research. In addition, Md. Hasanur Rashid (mrashid2@uncc.edu) will be our TA to interact with you diarly.
...
### Project 1: Locality through Unfolding and Recomposing GPU Kernels
...
### Project 2: Accelerated MatrixIRLS
...
### Project 3: Visualization for Heterogeneous Memory Access Patterns and Migration
...
### Project 4: Machine Learning-based Parameter Tuning in Large-scale System
...
### Project 7: Search and Removal of Redundant Instructions from Compiler IR and Binary
